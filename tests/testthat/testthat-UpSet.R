...
test_that("test expand_mode()", {
  expect_that(
    expand_mode(c(1, 1, 0), "intersect"),
    equals(rbind(c(1, 0, 0), c(0, 1, 0), c(1, 1, 0)))
  )
  expect_that(
    expand_mode(c(1, 1, 0), "union"),
