...
#' \code{na.rm} is enforced to be \code{TRUE}.
#' @param col A vector of colors that density values are mapped to.
#' @param color_space The color space in which colors are interpolated. Pass to
#' \code{\link[circlize]{colorRamp2}}.
#' @param ylab Label on y-axis.
#' @param column_title Title of the heatmap.
#' @param title Same as \code{column_title}.
#' @param ylim Ranges on the y-axis.
#' @param range Same as \code{ylim}.
#' @param title_gp Graphic parameters for title.
#' @param ylab_gp Graphic parameters for y-labels.
#' @param tick_label_gp Graphic parameters for y-ticks.
#' @param quantile_gp Graphic parameters for the quantiles.
#' @param show_quantiles Whether show quantile lines.
#' @param column_order Order of columns.
#' @param column_names_side Pass to \code{\link{Heatmap}}.
#' @param show_column_names Pass to \code{\link{Heatmap}}.
#' @param column_names_max_height Pass to \code{\link{Heatmap}}.
#' @param column_names_gp Pass to \code{\link{Heatmap}}.
#' @param column_names_rot Pass to \code{\link{Heatmap}}.
#' @param cluster_columns Whether cluster columns?
#' @param clustering_distance_columns There is a specific distance method
#' \code{ks} which is the Kolmogorov-Smirnov statistic between two
#' distributions. For other methods, the distance is calculated on the density
#' matrix.
#' @param clustering_method_columns Pass to \code{\link{Heatmap}}.
#' @param mc.cores Multiple cores for calculating ks distance. This argument
#' will be removed in future versions.
#' @param cores Multiple cores for calculating ks distance.
