...
#' Decorate Heatmap Bodies
#'
#' There is a viewport for each slice in each heatmap. This function contructs
#' the name of the viewport, goes to the viewport by
#' \code{\link[grid:viewports]{seekViewport}}, runs the code to that viewport
#' and finally goes back to the original viewport.
#'
#' @param heatmap Name of the heatmap which is set as \code{name} argument in
#' \code{\link{Heatmap}} function.
#' @param code Code that adds graphics in the selected heatmap body.
#' @param slice Index of the row slice in the heatmap.
#' @param row_slice Index of the row slice in the heatmap.
#' @param column_slice Index of the column slice in the heatmap.
#' @param envir Where to look for variables inside \code{code}.
...
#' Decorate Heatmap Dendrograms
#'
#' If you know the number of leaves in the dendrogram, it is simple to
#' calculate the position of every leave in the dendrogram. E.g., for the
#' column dendrogram, the i^th leave is located at:
#'
#' \preformatted{ # assume nc is the number of columns in the column slice
#' unit((i-0.5)/nc, "npc") }
#'
#' @param heatmap Name of the heatmap.
#' @param code Code that adds graphics in the selected heatmap dendrogram.
#' @param slice Index of the row slice or column slice in the heatmap.
#' @param which Is the dendrogram on rows or on columns?
#' @param envir Where to look for variables inside \code{code}.
#' @return This function returns no value.
#' @author Zuguang Gu <z.gu@@dkfz.de>
#' @seealso
...
#' Decorate Heatmap Column Dendrograms
#'
#' This is a wrapper function which pre-defined \code{which} argument in
#' \code{\link{decorate_dend}}.
#'
#' @param ... Pass to \code{\link{decorate_dend}}.
#' @param envir Where to look for variables inside \code{code}.
...
#' Decorate Heatmap Row Dendrograms
#'
#' This is a helper function which pre-defined \code{which} argument in
#' \code{\link{decorate_dend}}.
#'
#' @param ... Pass to \code{\link{decorate_dend}}.
#' @param envir Where to look for variables inside \code{code}?
...
#' Decorate Heatmap Dimension Names
#'
#' If you know the dimensions of the matrix, it is simple to calculate the
#' position of every row name or column name in the heatmap. E.g., for the
#' column column, the i^th name is located at:
#'
#' \preformatted{ # assume nc is the number of columns in the column slice
#' unit((i-0.5)/nc, "npc") }
#'
#' @param heatmap Name of the heatmap.
#' @param code Code that adds graphics in the selected viewport.
#' @param slice Index of the row slice or column slice in the heatmap.
#' @param which on rows or on columns?
#' @param envir where to look for variables inside \code{code}.
#' @return The function returns no value.
#' @author Zuguang Gu <z.gu@@dkfz.de>
#' @examples
...
#'
#' This is a helper function which pre-defined \code{which} argument in
#' \code{\link{decorate_dimnames}}.
#'
#' @param ... Pass to \code{\link{decorate_dimnames}}.
#' @param envir wWhere to look for variables inside \code{code}.
#' @return The function returns no value.
#' @author Zuguang Gu <z.gu@@dkfz.de>
#' @examples
#'
...
#' Decorate Heatmap Titles
#'
#' There is a viewport for row titles and column title in the heatmap. This
#' function contructs the name of the viewport, goes to the viewport by
#' \code{\link[grid:viewports]{seekViewport}} , runs code to that viewport and
#' finally goes back to the original viewport.
#'
#' @param heatmap Name of the heatmap.
#' @param code Code that adds graphics in the selected viewport.
#' @param slice Index of the row slice or column slice in the heatmap.
...
#'
#' This is a helper function which pre-defined \code{which} argument in
#' \code{\link{decorate_title}}.
#'
#' @param ... Pass to \code{\link{decorate_title}}.
#' @param envir Where to look for variables inside \code{code}.
#' @return The function returns no value.
#' @author Zuguang Gu <z.gu@@dkfz.de>
#' @examples
...
#' Decorate Heatmap Annotation
#'
#' There is a viewport for every column annotation and row annotation. This
#' function contructs the name of the viewport, goes to the viewport by
#' \code{\link[grid:viewports]{seekViewport}}, runs code to that viewport, and
#' finally goes back to the original viewport.
#'
#' @param annotation Name of the annotation.
#' @param code Code that adds graphics in the selected heatmap annotation.
#' @param slice Index of the row slices or the column slice in the heatmap.
#' @param envir Where to look for variables inside \code{code}.
#' @return The function returns no value.
#' @author Zuguang Gu <z.gu@@dkfz.de>
#' @seealso
